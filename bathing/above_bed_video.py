...
color_path = osp.join(args.save_dir, f'T{args.trial_idx}_eval_video_{args.sub_id}.mp4')
print(color_path)
...
try:
    ...
    cv2.imwrite(osp.join(args.save_dir, f'T{args.trial_idx}_eval_img_{args.sub_id}.png'), color_image)
    colorwriter.release()
    pipeline.stop()
