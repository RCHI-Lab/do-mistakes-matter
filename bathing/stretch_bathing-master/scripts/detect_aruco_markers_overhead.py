...
class ArucoMarker:
    def __init__(self, aruco_id, marker_info):
        ...
        self.frame_id = '/cam_1_color_optical_frame'
...
class DetectArucoNode:
    ...
    def publish_point_cloud(self):
        header = Header()
        header.frame_id = '/cam_1_color_optical_frame'
    ...
    def main(self):
        ...
        self.marker_info = rospy.get_param('/overhead_aruco_marker_info')
        self.aruco_marker_collection = ArucoMarkerCollection(self.marker_info)

        self.rgb_topic_name = '/cam_1/color/image_raw' #'/camera/infra1/image_rect_raw'
        self.rgb_image_subscriber = message_filters.Subscriber(self.rgb_topic_name, Image)

        self.depth_topic_name = '/cam_1/aligned_depth_to_color/image_raw'
        ...
        self.camera_info_subscriber = message_filters.Subscriber('/cam_1/color/camera_info', CameraInfo)
        ...
        self.visualize_markers_pub = rospy.Publisher('/aruco/overhead_marker_array', MarkerArray, queue_size=1)
        self.visualize_axes_pub = rospy.Publisher('/aruco/overhead_axes', MarkerArray, queue_size=1)
        self.visualize_point_cloud_pub = rospy.Publisher('/aruco/overhead_point_cloud2', PointCloud2, queue_size=1)

        self.wrist_top_marker_pub = rospy.Publisher('/aruco/overhead_wrist_top', Marker, queue_size=1)
        self.wrist_inside_marker_pub = rospy.Publisher('/aruco/overhead_wrist_inside', Marker, queue_size=1)
